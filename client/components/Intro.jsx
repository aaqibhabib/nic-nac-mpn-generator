        ...
        return (
            <div>
                <section className='section container'>
                    ...
                    <div style={{ width: "280", margin: '0 auto', paddingBottom: 10 }}><RaisedButton style={{ width: '100%', margin: '0 auto' }} buttonStyle={{ height: 70 }} overlayStyle={{ height: 70, paddingTop:14 }} labelStyle={{ fontSize: 28 }} onClick={this.props.onNextStep} label="Get Started" primary halfWidth /></div>
                </section>
